...
describe('CaixaDaLanchonete', () => {
    ...
    ])('compra de 3 itens em %p deve resultar em %p', (formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    ])('compra de múltiplas quantidades em %p deve resultar em %p', (formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
